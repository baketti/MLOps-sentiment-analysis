...
def make_prediction(app_config, text: str) -> dict:
    """
        Makes a sentiment prediction for the given text using the appropriate model based on the application configuration.
        Params:
            app_config (dict): The application configuration dictionary containing all necessary parameters and objects for prediction.
